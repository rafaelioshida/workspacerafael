 ...
 * se qtde 10-20 =>valor unitario 10% de redução
 * se qtde 5-9 =>valor unitario 5% de redução
 * se qtde <5 =>sem redução
 * se qtde >20 =>valor valor unitario com 12% de redução
 * 
 */
		
	String produto = JOptionPane.showInputDialog("Produto:");	
	float qtde = Float.parseFloat(JOptionPane.showInputDialog("Quantidade:"));
	float valoruni = Float.parseFloat(JOptionPane.showInputDialog("Valor unitário:"));
	
	
	if  (qtde > 20) {
		valoruni = valoruni * (float) 0.88;
		//System.out.println("Valor do produto " + produto + " é: R$" + valoruni);
